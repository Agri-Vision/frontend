        ...
        <Table>
          ...
          <TableBody>
            {currentData.map((row, rowIndex) => {
              // Apply row color based on 'yieldEstimation' if available
              const rowStyle = row.yieldEstimation
                ? { backgroundColor: getYieldColor(Number(row.yieldEstimation)) }
                : {};
              ...
              return (
                <TableRow
                  ...
                  style={rowStyle} // Apply calculated row color
                >
