...
const StressTb: React.FC = () => {
  ...
  const columns = [
    { label: 'ID', key: 'recordedDateTime' },
    { label: 'Block ID', key: 'temperature' },
    { label: 'Stress Status', key: 'humidity' },
    { label: 'Water Stress or Not', key: 'uvLevel' },
    { label: 'Effected Parameters', key: 'soilMoisture' },
    { label: 'Possible Actions', key: 'pressure' },
